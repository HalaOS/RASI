...
impl Eip2930TransactionRequest {
    ...
    pub fn rlp(&self) -> Result<Bytes> {
        ...
        let chain_id = self.tx.chain_id.unwrap_or(U256::new(1));
...
mod tests {
    ...
    fn test_rlp_failed() {
        ...
        assert_eq!(tx.tx.nonce, Some(U256::new(3)));
        assert_eq!(tx.tx.gas_price, Some(U256::new(1)));
        assert_eq!(tx.tx.gas, Some(U256::new(25000)));
        assert_eq!(tx.tx.value, Some(U256::new(10)));
