...
impl Libp2pExtension {
    ...
    ///
    /// On success, returns [`PeerId`](rep2p::identity::PeerId) derived from host public key.
...
///
/// On success, returns the [`PeerId`](rep2p::identity::PeerId) extract from [`libp2p public key extension`](https://github.com/libp2p/specs/blob/master/tls/tls.md)
