...
//!
//! You can register driver to the global registry using [`register_mio_timer`], or use it alone.
...
/// This function using [`register_timer_driver`] to register `MioTimer` to global registry.
///
/// So you may not call this function twice, otherwise will cause a panic. [`read more`](`register_timer_driver`)
